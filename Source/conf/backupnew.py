...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    model =  torch.hub.load('ultralytics/yolov5', 'custom', path ='best.pt').to(device) ### The repo is stored locally
    classes = ['kendaraan_berat', 'roda_4', 'roda_2']
...
main(img_path="0ed19ad4-1636062728172_Isuzu_Elf_2016_Lorry.jpg") ## for image
